...
namespace DAL.Migrations
{
    ...
    [Migration("20180801111133_them-column-product-details")]
    partial class themcolumnproductdetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Model.CM.CM_Customer", b =>
                {
                    b.HasOne("DAL.Model.System_User", "CreatedUser")
                        .WithMany()
                        .HasForeignKey("CreatedUserId");

                    b.HasOne("DAL.Model.System_User", "DeletedUser")
                        .WithMany()
                        .HasForeignKey("DeletedUserId");

                    b.HasOne("DAL.Model.System_User", "EditedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Model.SM.SaleOrder", b =>
                {
                    ...
                    b.HasOne("DAL.Model.System_User", "ReviewBy")
                        .WithMany()
